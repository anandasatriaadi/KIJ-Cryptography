			...
			vector<string> rk)
{
	...
	for (int i = 0; i < 16; i++) {
        ...
        // cout << "lpt = " << left << "\n";
        // cout << "rpt = " << right << "\n";
        // cout << "lpt = " << bin2hex(left) << "\n";
        // cout << "rpt = " << bin2hex(right) << "\n";
        cout<< "\n";
    ...
    // cout << "final_perm = " << combine << "\n";
    // cout << "final_perm = " << permute(combine, final_perm, 64) << "\n";
...
int main()
{
	...
	for (int i = 0; i < 16; i++) {
        ...
        // cout << "round " << i+1 << " = " << left << " shifts " << shift_table[i] << "\n";
